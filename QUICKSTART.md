...
import { SolanaTipSDK, LowdbAdapter } from '@anuragchvn-blip/solana-tip-overlay-sdk';
...
```html
<script type="module">
  import { PhantomWalletAdapter, TipSender } from '@anuragchvn-blip/solana-tip-overlay-sdk/client';
